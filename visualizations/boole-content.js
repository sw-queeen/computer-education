...
(function () {
  ...
  function renderSummary() {
    ...
    <div class="detail-section">
      <div class="detail-section-title" style="--subject-accent:${ACCENT};">
        부울 대수 법칙
        <span style="margin-left:8px;font-size:10px;font-weight:700;background:${ACCENT};color:white;padding:2px 8px;border-radius:20px;letter-spacing:.03em;">19개 전체 암기</span>
      </div>
  ...
  const QUIZ_DATA = [
    ...
    { type:'mc', q:"(A·B·C)' 를 드모르간 법칙으로 올바르게 변환한 것은?", options:["A'·B'·C'", "A'+B'·C'", "A'+B'+C'", "(A'+B')·C'"], answer:2, explain:"드모르간: (A·B·C)' = A'+B'+C'. AND의 부정은 각 변수를 부정한 후 OR로 연결. 순서대로 적용: (A·B·C)' = (A·B)' + C' = A'+B'+C'." },

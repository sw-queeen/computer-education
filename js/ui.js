...
(function (CS) {
  ...
  */
  ...
  /* .mode-toggle-btn, .explore-tab-btn은 제외 — 둘 다 이제 액체
     방울이 흐르는 자체 모션(components.css의 .mode-toggle-liquid /
     .explore-tab-liquid)을 쓰므로, 여기 젤리 바운스까지 겹치면 두
     모션이 서로 충돌해 보인다. */
  var WOBBLE_SELECTOR = [
